...
| --- | --- | --- | --- |
| v1.1.7 | 2026-07-26 | Baseline | Normalized Version History to strict descending semantic-version order to match repository validation governance; no Protocol YAML semantics changed. |
