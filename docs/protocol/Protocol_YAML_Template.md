...
| --- | --- | --- | --- |
| v1.1.1 | 2026-07-26 | Baseline | Normalized Version History to strict descending semantic-version order to match repository validation governance; no Protocol template semantics changed. |
