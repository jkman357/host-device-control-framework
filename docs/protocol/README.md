...
- [`Protocol_YAML_Definition_Guide.md`](Protocol_YAML_Definition_Guide.md) — **Baseline** syntax, semantics, conditional `node_model`, machine-verifiable representation, Schema Validation, Semantic Lint, Code Generation, Golden Vector, and independent Protocol Conformance Tester applicability, independence, staged baseline lifecycle, exact tested-candidate evidence binding, release reconciliation, and representative-target claim boundaries.
