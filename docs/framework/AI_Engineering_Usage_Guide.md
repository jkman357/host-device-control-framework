...
|---|---|---|---|---|
| AI Engineering Usage Guide | `docs/framework/AI_Engineering_Usage_Guide.md` | `v1.0.36` | Draft for Review | AI authority routing and operating controls |
...
| Repository Validation Checklist | `docs/validation/Repository_Validation_Checklist.md` | `v1.0.15` | Draft for Review | Repository structural, authority synchronization, canonical claim-source, legal-baseline, external-anchor, release-state, third-party byte/evidence, and evidence checks |
