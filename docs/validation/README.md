...
- [`Repository_Validation_Checklist.md`](Repository_Validation_Checklist.md) — **Draft for Review / operational checklist** for repository structure, non-link filesystem-entry safety, canonical authority-registry paths, current Changelog authority-revision snapshot, scoped release-state claims, references, metadata, Protocol schema/fixtures, CI, and package integrity.
