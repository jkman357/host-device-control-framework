...
- [`Protocol_Validation_Checklist.md`](Protocol_Validation_Checklist.md) — **Draft for Review / conformance checklist** for Protocol definition, `node_model`, topology, identity/addressing, targeting, scope, compatibility, security, malformed input, fixtures, independent Protocol Conformance Tester execution, and interoperability evidence.
