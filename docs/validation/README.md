...
- [`Repository_Validation_Checklist.md`](Repository_Validation_Checklist.md) — **Draft for Review / operational checklist** for repository structure, authority manifests, current Changelog authority-revision snapshot, release-state claims, references, metadata, Protocol schema/fixtures, CI, and package integrity.
