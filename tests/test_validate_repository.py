...
class RepositoryValidatorTests(unittest.TestCase):
    ...
    def test_registry_versions_match_updated_documents(self) -> None:
        ...
        expected = {
            "docs/framework/AI_Engineering_Usage_Guide.md": "v1.1.1",
            ...
            "docs/validation/Repository_Validation_Checklist.md": "v1.1.1",
    ...
    def test_current_history_date_and_status_are_enforced(self) -> None:
        ...
        text = path.read_text(encoding="utf-8").replace(
            "| v1.1.1 | 2026-07-27 | Baseline |",
            "| v1.1.1 | 2026-02-30 | Draft for Review |",
            1,
        )
        path.write_text(text, encoding="utf-8")
    ...
    def test_release_candidate_must_remain_draft(self) -> None:
        path = self.root / "docs/framework/AI_Engineering_Usage_Guide.md"
        text = path.read_text(encoding="utf-8")
        text = text.replace("**Document Version:** v1.1.1", "**Document Version:** v1.1.1-rc.1", 1)
        text = text.replace("| v1.1.1 | 2026-07-27 | Baseline |", "| v1.1.1-rc.1 | 2026-07-27 | Baseline |", 1)
        path.write_text(text, encoding="utf-8")
    ...
    def test_mutable_repository_cannot_self_assert_release_freeze(self) -> None:
        ...
        text = path.read_text(encoding="utf-8").replace(
            ...
            "The repository content is frozen as the `v1.1.1` Baseline.",
            1,
        )
        path.write_text(text, encoding="utf-8")
    ...
    def test_current_status_decoy_outside_controlled_section_is_rejected(self) -> None:
        path = self.root / "README.md"
        text = path.read_text(encoding="utf-8")
        marker = "The repository content has received explicit human freeze approval for the `v1.1.1` Baseline."
