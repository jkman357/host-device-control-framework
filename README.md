...
|---|---:|---|---|
| [`AI_Engineering_Usage_Guide.md`](docs/framework/AI_Engineering_Usage_Guide.md) | v1.0.33 | Draft for Review | AI entry point, authority routing, Multi-Node-aware task workflows, evidence states, exact tested-candidate evidence routing, Tester self-validation, and human approval boundary |
...
| [`Repository_Validation_Checklist.md`](docs/validation/Repository_Validation_Checklist.md) | v1.0.12 | Draft for Review | Repository structural, registry, canonical claim-source, legal-baseline, external-anchor, release-freeze, third-party byte/evidence, executable Protocol schema/fixture, evidence-state, and detached-package checks |
