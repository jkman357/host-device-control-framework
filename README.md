...
|---|---:|---|---|
| [`AI_Engineering_Usage_Guide.md`](docs/framework/AI_Engineering_Usage_Guide.md) | v1.0.31 | Draft for Review | AI entry point, authority routing, Multi-Node-aware task workflows, evidence states, exact tested-candidate evidence routing, and human approval boundary |
...
| [`Protocol_Validation_Checklist.md`](docs/validation/Protocol_Validation_Checklist.md) | v1.1.5 | Draft for Review | Traceable Protocol YAML, node_model, topology, identity, security, compatibility, independent Protocol Conformance Tester applicability, staged gates, exact tested identities, evidence freshness, representative-target residual boundaries, and interoperability evidence view |
